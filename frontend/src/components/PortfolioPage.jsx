                ...
                >
                  <td className="px-5 py-2.5 text-gray-300 max-w-[240px]">
                    <div className="flex items-center gap-1.5">
                      ...
                      {p.yf_ticker
                        ? <Link to={`/app/stock/${p.yf_ticker}`} className="truncate block hover:text-indigo-300 transition-colors" onClick={e => e.stopPropagation()} title={p.instrument}>{p.instrument}</Link>
              ...
              return (
                <tr key={i} className="hover:bg-white/[0.02] transition">
                  <td className="px-5 py-2.5 text-gray-300 max-w-[180px] sticky left-0 bg-[#0a0a0f]">
                    {pos.yf_ticker
                      ? <Link to={`/app/stock/${pos.yf_ticker}`} className="truncate block hover:text-indigo-300 transition-colors" title={pos.instrument}>{pos.instrument}</Link>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-[#13131f] border border-white/10 rounded-2xl px-10 py-8 flex flex-col items-center gap-4 shadow-2xl">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500 text-xs mt-1">Fetching latest market data…</p>
            </div>
          </div>
        </div>
      )}
